...
console.log("TextCursor is mounted successfully");
const TextCursor = ({
  text = "⚛️",
  delay = 0.01,
  spacing = 100,
...
// replace the existing useEffect that attaches to container with this:
useEffect(() => {
  // attach to window so we always get mouse coords
